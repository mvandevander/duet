...
{
    this->type = "ParticleSystemType"; //we need the type because it counteracts the ambiguity of polymorphism
    this->x = x;
    this->y = y;
    this->w = w;
    this->h = h;
    ...
    this->particle_frequency = 10;
       this->particle_min_life = 10;
       this->particle_max_life = 25;
       this->particle_min_xv = 0;
       this->particle_max_xv = 0;
       this->particle_min_xa = 0;
       this->particle_max_xa = 0;
       this->particle_min_yv = 0;
       this->particle_max_yv = 0;
       this->particle_min_ya = 0;
       this->particle_max_ya = 0;
       this->particle_min_rotv = 0;
       this->particle_max_rotv = 0;
       this->particle_min_rota = 0;
       this->particle_max_rota = 0;
       this->particle_min_width = 20;
       this->particle_max_width = 20;
       this->particle_min_widthv = 0;
       this->particle_max_widthv = 0;
       this->particle_min_widtha = 0;
       this->particle_max_widtha = 0;
       this->particle_min_height = 20;
       this->particle_max_height = 20;
       this->particle_min_heightv = 0;
       this->particle_max_heightv = 0;
       this->particle_min_heighta = 0;
       this->particle_max_heighta = 0;
       this->particle_middle_t = 50;
       this->particle_middle_len = 20;
       this->particle_start_r = 0;
       this->particle_start_g = 0;
       this->particle_start_b = 0;
       this->particle_start_a = .5;
       this->particle_middle_r = 1;
       this->particle_middle_g = 0;
       this->particle_middle_b = 0;
       this->particle_middle_a = 1;
       this->particle_end_r = 0;
       this->particle_end_g = 1;
       this->particle_end_b = 0;
       this->particle_end_a = 0;
       this->build_a_particle = 10;
}
...
Entity_ParticleSystemType::~Entity_ParticleSystemType()
{
    ...
    void Entity_ParticleSystemType::set_parameters(int particle_frequency, int particle_min_life, int particle_max_life, float particle_min_xv, float particle_max_xv, float particle_min_xa,
                                                   float particle_max_xa, float particle_min_yv, float particle_max_yv, float particle_min_ya, float particle_max_ya, float particle_min_rot, float particle_max_rot,
                                                   float particle_min_rotv, float particle_max_rotv, float particle_min_rota, float particle_max_rota, float particle_min_width,
                                                   float particle_max_width, float particle_min_widthv, float particle_max_widthv, float particle_min_widtha, float particle_max_widtha,
                                                   ...
                                                   float particle_end_r, float particle_end_g, float particle_end_b, float particle_end_a)
                                                   {
                                                       ...
                                                       this->particle_max_yv = particle_max_yv;
...
void Entity_ParticleSystemType::update()
{
    ...
    build_a_particle+=particle_frequency;
    while(build_a_particle>=10) {
        //this may be the part that is bugged-> For some reason, I'm getting wierd stretched (uninitialized?) particles being drawn across half the screen.
        //it's either here or the drawing routine
    ...
    /* Old Particle adding system, do not re-engage

...
Entity_CollisionType_White_Button::Entity_CollisionType_White_Button(int x, int y, int w, int h)
{
    this->type = "CollisionType_White_Button"; //we need the type because it counteracts the ambiguity of polymorphism
    this->x = x;
    this->y = y;
    this->w = w;
    this->h = h;
...
bool Entity_CollisionType_White_Button::serialize(fstream& file)
{
    ...
    int Entity_CollisionType_White_Button_version = 1;
    file.write((char*) &Entity_CollisionType_White_Button_version, sizeof(Entity_CollisionType_White_Button_version));
...
bool Entity_CollisionType_White_Button::unserialize(ifstream& file)
{
    if(!file.is_open()) return false;
    int Entity_CollisionType_White_Button_version;
    file.read((char*) &Entity_CollisionType_White_Button_version, sizeof(int));
    if(Entity_CollisionType_White_Button_version==1){
